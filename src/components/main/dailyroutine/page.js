          ...
          >
            <div className="">
              <div className="space-y-5 bg-white p-4 rounded-sm ">
                <h1 className={` head text-xl `}>Vedic Astrology</h1>
                <hr />
                ...
                <Image
                  ...
                  />
                  <div className="">
                    <h1 className={` head text-lg`}>Sun Sign</h1>
                ...
                <div className="flex items-start space-x-4 border-b-2 py-2 ">
                  ...
                  />
                  <div className="">
                    <h1 className={` head text-lg`}>Moon Sign</h1>
                    <p className="text-sm text-slate-600">
                      On the other hand, we denounce with righteous indignation
                      and dislike men.
                    </p>
                ...
                <div className="flex items-start space-x-4 border-b-2 py-2 ">
                  ...
                  />
                  <div className="">
                    <h1 className={` head text-lg`}>Planets</h1>
                    <p className="text-sm text-slate-600">
                      On the other hand, we denounce with righteous indignation
                      and dislike men.
                    </p>
                ...
                <div className="flex items-start space-x-4 border-b-2 py-2 ">
                  ...
                  />
                  <div className="">
                    <h1 className={` head text-lg`}>Ascedant</h1>
                    <p className="text-sm text-slate-600">
                      On the other hand, we denounce with righteous indignation
                      and dislike men.
                    </p>
                ...
                <div className="flex items-start space-x-4 border-b-2 py-2 ">
                  ...
                  />
                  <div className="">
                    <h1 className={` head text-lg`}>Twelve House</h1>
                    <p className="text-sm text-slate-600">
                      On the other hand, we denounce with righteous indignation
                      and dislike men.
                    </p>
                ...
                <div className="flex items-start space-x-4 border-b-2 py-2 ">
                  ...
                  />
                  <div className="">
                    <h1 className={` head text-lg`}>Nakshatras</h1>
                    <p className="text-sm text-slate-600">
                      On the other hand, we denounce with righteous indignation
                      and dislike men.
                    </p>
              ...
              <div className="bg-white p-3 my-5 space-y-5">
                <h1 className={` head text-xl `}>Baby Names By Nakshatra</h1>
                <hr />
                <Image
                  src="/main/baby.jpg"
                  width="200"
            ...
            <div className="space-y-5 bg-white p-4 rounded-sm sm:h-[75%] ">
              <h1 className={` head text-xl `}>Astrology Advice</h1>
              <hr />
              <div className="flex items-start space-x-4 border-b-2 py-2">
               <Image
                    src="/main/sun.png"
                  ...
                  />
                <div className="">
                  <h1 className={` head text-lg`}>Career</h1>
                  <p className="text-sm text-slate-600">
            ...
            <div className="">
              <div className="bg-white p-3 rounded-sm  space-y-5 relative ">
                <h1 className={` head text-xl `}>Vastu Shastra</h1>
                <hr />
                <Image
                  src="/main/baby.jpg"
                  width="200"
              ...
              <div className="bg-white p-3 rounded-sm  space-y-5 relative my-5">
                <h1 className={` head text-xl `}>Birth Journal (Kundli)</h1>
                <hr />
                <Image
                  src="/main/baby.jpg"
                  width="200"
