    ...
    <>  
      <section className="py-2 desktop cursor-pointer">
        <div
          className={`   p-3 ${
            nav
              ? "fixed top-0 w-[100%] px-20 z-50 bg-gray-900   duration-75 transition-transform translate-y-0 ease-in"
              : "static w-[80%] px-0 container mx-auto"
          } `}
          style={{ zIndex: "99999" }}
        >
            ...
            <ul className="flex items-center space-x-6">
              <li className="navlist p-3 rounded-sm homelist">
                ...
                <ul className="homechild  w-32 ">
                  ...
                  <li className="border-b p-2 border-slate-600">
                    Vastu Shastra
                  </li>
              ...
              <li className="navlist p-3 rounded-sm shoplist">
                Shop
              ...
              <li className="navlist p-3 rounded-sm pagelist">
                Pages
