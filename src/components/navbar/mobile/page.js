        ...
        {  topnav?  (
          <div className=" flex justify-between items-center transition-all">
            ...
            >
              ...
              <li className="navlist p-3 border-b border-slate-600 rounded-sm">
